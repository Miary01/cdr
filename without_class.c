...
void print(int first_bit,int second_bit,int third_bit,int last_bit,int first_bit_1,int second_bit_1,int third_bit_1,int last_bit_1) {
	printf("netmask: %d.%d.%d.%d\n",first_bit,second_bit,third_bit,last_bit);
	printf("@ network: %d.%d.%d.%d\n",first_bit_1,second_bit_1,third_bit_1,last_bit_1);
}
